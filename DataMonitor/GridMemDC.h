...
//* FileName:		MemDC.h
//*
//* Contents:		Definition and implementation for CGridMemDC
//*
...
//* 12.feb.98	Jan Vidar Berger	Ported CGridMemDC into clPlot and added some comments.
//*******************************************************************************************************/
#ifndef _MEMDC_H_
#define _MEMDC_H_
...
//*******************************************************************************************************/
//* Class:			CGridMemDC - memory DC
//*
//* Base Class:		public CDC
//*
//* Description:	This class implements a memory Device Context that enables flicker free drawing.
//*
//* Usage:			Implemen CGridMemDC in your CMyWnd::OnPaint as following:
//*							{
//*								CPaintDC	dc(pWnd);
//*								CGridMemDC		mDC(dc);	// call CGridMemDC::CGridMemDC(CDC *dc)
//*
//*								Draw(mDC);				// draw on CGridMemDC rather than CDC directly.
//*							}							// call CGridMemDC::~CGridMemDC()
//*
...
//*					2.	You can draw on the CGridMemDC as if it is a CDC.
//*					3.	The destructor copies the memory dc into the real DC.
//*******************************************************************************************************/
class CGridMemDC : public CDC {
private:
        CBitmap m_bitmap;								// Offscreen bitmap
        CBitmap* m_oldBitmap;							// bitmap originally found in CGridMemDC
        CDC* m_pDC;										// Saves CDC passed in constructor
        CRect m_rect;									// Rectangle of drawing area.
        BOOL m_bMemDC;									// TRUE if CDC really is a Memory DC.
public:
        CGridMemDC(CDC* pDC) : CDC(), m_oldBitmap(NULL), m_pDC(pDC)
        {
