...
BOOL CCurvePage::OnInitDialog()
{
	...
	((CComboBox*)GetDlgItem(IDC_COMBO_XIANXING))->InsertString(3,_T("点划线"));//PS_DASHDOT  /* _._._._  */
	((CComboBox*)GetDlgItem(IDC_COMBO_XIANXING))->InsertString(4,_T("双点划线"));//PS_DASHDOTDOT  /* _.._.._  */
